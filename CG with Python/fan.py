...
X1, Y1, X2, Y2, X3, Y3 = 0.0, 0.0, 20.0, 70.0, -20.0, 70.0
angle = 0.0
speed_factor = 0.05  
...
def update(value):
    global X1, Y1, X2, Y2, X3, Y3, angle, speed_factor
    glutPostRedisplay()
    glutTimerFunc(int(2000/60), update, int(0))  
...
def display():
    ...
    X1, Y1, X2, Y2, X3, Y3 = rotation(X1, Y1, X2, Y2, X3, Y3, 0, 0, 90)
    triangle(X1, Y1, X2, Y2, X3, Y3, colour)
    X1, Y1, X2, Y2, X3, Y3 = rotation(X1, Y1, X2, Y2, X3, Y3, 0, 0, 180)
    triangle(X1, Y1, X2, Y2, X3, Y3, colour)
    X1, Y1, X2, Y2, X3, Y3 = rotation(X1, Y1, X2, Y2, X3, Y3, 0, 0, 270)
    triangle(X1, Y1, X2, Y2, X3, Y3, colour)
    glutSwapBuffers()
